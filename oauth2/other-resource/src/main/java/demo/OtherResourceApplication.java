...
public class OtherResourceApplication extends ResourceServerConfigurerAdapter {

    private static Logger LOG = Logger.getLogger(OtherResourceApplication.class);
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(OtherResourceApplication.class, args);
    }
    ...
    public Message home(HttpServletRequest request,
        ...
        return new Message("Hello World from other resource");
    }
    ...
    public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
        resources.resourceId("resource-id2");
    }
